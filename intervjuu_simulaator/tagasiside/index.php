...
<body>
    <div id="main">
        ...
        <form method="post" action="submit_feedback.php">
            ...
            <br>
            <textarea name="detail_feedback" id="detail_feedback" placeholder="Trüki siia" maxlength="400"></textarea>
            <br>
            <label for="question" id="question">Kui soovid küsida meilt midagi:</label>
            <br>
            <input type="text" name="question" id="question" placeholder="Trüki siia" maxlength="400">
            <br>
            <label for="email">Kui soovid oma küsimustele vastust, siis jäta oma e-maili aadress:</label>
            <br>
            <input type="email" name="email" id="email" placeholder="Sisesta e-mail" maxlength="50">
            <br><br>
