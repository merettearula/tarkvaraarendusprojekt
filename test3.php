...
<table id="resultsTable">
  <thead>
    ...
    $stmt = $conn->prepare("SELECT t.id, t.ip_aadress, t.aeg_algus, t.aeg_lopp, t.soorituste_arv, t.vastamata, t.kasutaja_id, t.oigesti, t.valesti, t.vastamata_nr, t.oigesti_nr, t.valesti_nr,  k.nimi, k.haridus, k.amet, k.huvid FROM tulemus t INNER JOIN kasutaja k ON t.kasutaja_id = k.id");
    $conn->set_charset("utf8");
    echo $conn->error;
    $stmt->execute();
    $stmt->bind_result($id, $ip_aadress, $aeg_algus, $aeg_lopp, $soorituste_arv, $vastamata, $kasutaja_id, $oigesti, $valesti, $vastamata_nr, $oigesti_nr, $valesti_nr, $nimi, $haridus, $amet, $huvid);
